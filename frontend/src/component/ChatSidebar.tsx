      ...
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="justify-between">
                <img
                  className="text-white rounded-xl bg-white w-10 h-10"
                  src="/appLogo.png"
                />
              </div>
            ...
            <button
              className={`p-2.5 rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl ${
                showAllUsers
        ...
        <div className="p-4 border-t border-gray-700 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-red-600 transition-colors text-red-500 hover:text-white cursor-pointer"
          >
